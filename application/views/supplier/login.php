...
<body>
    ...
    <div class="loginBlock" id="login" style="display: block;">
        ...
        <div class="loginForm">
        	<?php echo form_open('supplier/session/login', array('class' => 'form-horizontal')); ?>
                ...
                <div class="control-group">
                    <div class="input-prepend">
                        ...
                        <input type="text" name="Email" id="Email" placeholder="Email" class="validate[required]"/>
                    </div>                
                </div>
                <div class="control-group">
                    <div class="input-prepend">
    ...
    <div class="loginBlock" id="forgot">
        ...
        <div class="dr"><span></span></div>
        <div class="loginForm">            
            <?php echo form_open('supplier/session/forgot_password', array('class' => 'form-horizontal')) ?>
