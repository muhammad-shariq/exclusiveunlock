<div class="workplace">
  <div class="row-fluid">
    ...
    <?php
            echo form_open('admin/brand/add',array('method' => 'post','id'=>'form'));
?>
    <div class="head clearfix">
          ...
          <?php
            echo form_submit(array('value'=> 'Add Brand','class'=>'btn'));
            echo form_close();
          ?>
      </div>                                
...
$(document).ready(function()
  {
		...
		({
		      ...
		      'sAjaxSource'    : '<?php echo site_url('admin/brand/listener'); ?>',
