    ...
    <div class="wrapper"> 
        ...
        <div class="menu">                
            ...
            <div class="admin active">
                ...
                <ul class="control">
                    <li><span class="icon-user"></span> <a href="<?php echo site_url('admin/employee/profile'); ?>">Update Profile</a></li>
            ...
            <ul class="navigation">            
                ...
                */?>
                 ...
                 <li class="openable <?php echo(in_array($this->uri->segment(2), array('apimanager', 'brand', 'servicemodel'))?'active':''); ?>">
                    <a href="#">
                        <span class="isw-cloud"></span><span class="text">Api Manager</span>
                    </a>
                    <ul>                    	 
                		<li <?php echo($this->uri->segment(2)=='apimanager'?'class="active"':''); ?>>
                            <a href="<?php echo site_url("admin/apimanager"); ?>">
                                <span class="icon-share"></span><span class="text">Api Manager</span>
                            </a>                  
                        </li>
                        <li <?php echo($this->uri->segment(2)=='brand'?'class="active"':''); ?>>
                            <a href="<?php echo site_url("admin/brand"); ?>">
                                <span class="icon-tags"></span><span class="text">Mobile Brands</span>
                            </a>                  
                        </li>
                        <li <?php echo($this->uri->segment(2)=='servicemodel'?'class="active"':''); ?>>
                            <a href="<?php echo site_url("admin/servicemodel"); ?>">
                                <span class="icon-tag"></span><span class="text">Brand Models</span>
                            </a>                  
                        </li>
                ...
                <li class="openable <?php echo(in_array($this->uri->segment(2), array('network', 'method', 'imeiorder'))?'active':''); ?>">
                    <a href="#">
                        <span class="isw-target"></span><span class="text">IMEI Service</span>
                    </a>
                    <ul>
                        <li <?php echo($this->uri->segment(2)=='network'?'class="active"':''); ?>>
                            <a href="<?php echo site_url("admin/network"); ?>">
                                <span class="icon-map-marker"></span><span class="text">Networks</span>
                            </a>                  
                        </li>                    	
                        <li <?php echo($this->uri->segment(2)=='method'?'class="active"':''); ?>>
                            <a href="<?php echo site_url("admin/method"); ?>">
                                <span class="icon-road"></span><span class="text">Methods</span>
                            </a>                  
                        </li>
                        <li <?php echo($this->uri->segment(2)=='imeiorder'?'class="active"':''); ?>>
                            <a href="<?php echo site_url("admin/imeiorder"); ?>">
                                <span class="icon-thumbs-up"></span><span class="text">Orders</span>
                            </a>                  
                        </li>                                              
                    </ul>                
            	</li>
            	<li class="openable <?php echo(in_array($this->uri->segment(2), array('fileservices', 'fileorder'))?'active':''); ?>">
                    <a href="#">
                        <span class="isw-documents"></span><span class="text">File Service</span>
                    </a>
                    <ul>
                        <li <?php echo($this->uri->segment(2)=='fileservices'?'class="active"':''); ?>>
                            <a href="<?php echo site_url("admin/fileservices"); ?>">
                                <span class="icon-file"></span><span class="text">File Services</span>
                            </a>                  
                        </li>
                        <li <?php echo($this->uri->segment(2)=='fileorder'?'class="active"':''); ?>>
                            <a href="<?php echo site_url("admin/fileorder"); ?>">
                                <span class="icon-thumbs-up"></span><span class="text">File Service Orders</span>
                            </a>                  
                        </li>                                              
                    </ul>                
            	</li>
            	<li class="openable <?php echo(in_array($this->uri->segment(2), array('group', 'member'))?'active':''); ?>">
                    <a href="#">
                        <span class="isw-users"></span><span class="text">Members & Groups</span>
                    </a>
                    <ul>
                        <li <?php echo($this->uri->segment(2)=='group'?'class="active"':''); ?>>
                            <a href="<?php echo site_url("admin/group"); ?>">
                                <span class="icon-briefcase"></span><span class="text">Groups</span>
                            </a>                  
                        </li>                    	
                ...
                <?php /*<li <?php echo($this->uri->segment(2)=='supplier'?'class="active"':''); ?>>
                    <a href="<?php echo site_url("admin/supplier"); ?>">
                        <span class="isw-fullscreen"></span><span class="text">Suppliers</span>                 
                    </a>
                </li>*/ ?>                
                <li <?php echo($this->uri->segment(2)=='employee'?'class="active"':''); ?>>
                    <a href="<?php echo site_url("admin/employee"); ?>">
                        <span class="isw-unlock"></span><span class="text">Employees Access</span>                 
                    </a>
                </li>
                <li <?php echo($this->uri->segment(2)=='credit'?'class="active"':''); ?>>
                    <a href="<?php echo site_url("admin/credit"); ?>">
                        <span class="isw-calc"></span><span class="text">Credits Management</span>
                    </a>               
            	</li>
            	<li <?php echo($this->uri->segment(2)=='payment'?'class="active"':''); ?>>
                    <a href="<?php echo site_url("admin/payment"); ?>">
                        <span class="isw-tag"></span><span class="text">Payment Methods</span>
                    </a>               
            	</li>
                <li <?php echo($this->uri->segment(2)=='autoresponder'?'class="active"':''); ?>>
                    <a href="<?php echo site_url("admin/autoresponder"); ?>">
                        <span class="isw-mail"></span><span class="text">Email Templates</span>
                    </a>               
            	</li>                
