<div class="workplace">
  <div class="row-fluid">
    ...
    <?php
            echo form_open('admin/group/add',array('method' => 'post','id'=>'form'));
?>
          ...
          <div class="block-fluid table-sorting clearfix">
            ...
            <?php
            echo form_submit(array('value'=> 'Add Group','class'=>'btn'));
echo form_close();
          ?>
      </div>                                
...
$(document).ready(function()
  {
		...
		({
		      ...
		      'sAjaxSource'    : '<?php echo site_url('admin/group/listener'); ?>',
