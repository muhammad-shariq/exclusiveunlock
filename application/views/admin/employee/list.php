<div class="workplace">
    <div class="row-fluid">
        ...
        <?php $this->load->view('admin/includes/message'); ?>
            ...
            <a href="<?php echo site_url('admin/employee/add') ?>"><button class="btn" type="button">Add Employee</button></a>
        </div>                                
        ...
        <div class="span3">
          ...
          <div class="block">
            <ul class="the-icons clearfix">
              <li><i class="isb-ok"></i> Edit Role</li>
...
$(document).ready(function()
  {
		...
		({
		      ...
		      'sAjaxSource'    : '<?php echo site_url('admin/employee/listener'); ?>',
